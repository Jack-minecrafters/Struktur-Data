...
class LinkedList:
    ...
    def delete_back(self):
        ...
        prev = temp.next
        temp.next = None
        # mengembalikan data yang dihapus return prev.data
        return prev.data

# Contoh penggunaan linked list my_list = LinkedList()
my_list = LinkedList()
    ...
    if pil == 1:
        ...
        while temp:
            ...
            if pilmenu == 1:
                ...
                print(f'Data {data} berhasil ditambahkan dí akhir linked list')
            elif pilmenu == 0:
                temp = False
                break
    elif pil == 2:
